...
function FeaturesBlocks() {
  return (
    <section className="relative">
      ...
      <div className="h-20 w-20 flex text-center bg-slate-100 rounded-full ">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          {/* Section header */}
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20 text-danse-green-500">
            <h2 className="h2 mb-4">Lugar del Evento</h2>
            <p className="text-xl text-danse-green-500">
              De todos los lugares en lo que he estado, el mejor es a tu lado
            </p>
          </div>
        </div>
              ...
              >
                <g fill="none" fillRule="evenodd">
                  ...
                  <g strokeWidth="2" transform="translate(19.429 20.571)">
                    ...
                    <path
                      className="stroke-current text-white"
                      d="M19.153 23.267c3.59-2.213 5.99-6.169 5.99-10.696C25.143 5.63 19.514 0 12.57 0 5.63 0 0 5.629 0 12.571c0 4.527 2.4 8.483 5.99 10.696 5.99"
                    />
                    <path
                      className="stroke-current text-blue-300"
