...
function PhotoSection() {
  return (
    <section className="relative">
      <div className="md:grid md:grid-cols-12 max-w-xl md:max-w-none md:w-full bg-slate-200">
        ...
        <div className="flex-col flex justify-center md:col-span-4 bg-slate-200 md:transform md:-translate-x-12 md:-skew-x-12 h-80 md:h-screen gradient-mask-t-20 md:gradient-mask-l-20">
